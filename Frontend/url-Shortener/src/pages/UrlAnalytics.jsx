    ...
    return (
        <div>
            ...
            <div className="mt-4 bg-white p-4 rounded-lg shadow-md">
                <h3 className="text-lg font-semibold mb-4">Clicks by Location for:: {`http://localhost:3000/short/${url?.shortUrl}`}</h3>
            ...
            <div className="mt-4 bg-white p-4 rounded-lg shadow-md">
                <h3 className="text-lg font-semibold mb-4">Clicks by Device for:: {`http://localhost:3000/short/${url?.shortUrl}`}</h3>
